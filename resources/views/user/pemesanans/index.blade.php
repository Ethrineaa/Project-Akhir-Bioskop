...
<div class="max-w-6xl mx-auto px-4 py-10">
    ...
    <div class="mb-6">
        <div class="relative">
            ...
            >
            <svg class="absolute right-3 top-2.5 h-5 w-5 text-gray-400"
    ...
    @if (
        $pemesanans->filter(fn ($p) =>
            optional($p->pembayaran)->status === 'paid'
        )->isEmpty()
    )
    ...
    <div id="bookingList" class="space-y-4">
        ...
        @foreach ($pemesanans as $pemesanan)
            ...
            <div
                class="booking-item bg-white rounded-xl shadow-sm border border-gray-200
                ...
                <div class="flex-1">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                {{ $jadwal?->studio->nama ?? 'N/A' }}
                                • Hall {{ $jadwal?->studio->nomor_hall ?? '-' }}
                            </p>

                            <p class="text-sm text-gray-500 mt-1">
                                Seats: {{ $pemesanan->nomor_kursi }}
                            </p>
                        </div>
                        ...
                        <div class="text-right">
                            ...
                            <span class="inline-block mt-2 px-2 py-1 text-xs font-medium

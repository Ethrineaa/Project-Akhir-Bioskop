    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-[#0B1220] rounded-xl p-4">
                ...
                <div class="flex justify-between items-center bg-gray-800 rounded-lg p-3 mb-3 hover:bg-gray-700 cursor-pointer">
                    <div>
        ...
        <div class="bg-[#0B1220] rounded-xl p-5 h-fit sticky top-24">
            ...
            {{-- PAY BUTTON --}}
            <button
                class="w-full mt-6 bg-blue-600 hover:bg-blue-700 py-3 rounded-xl font-semibold transition">
